...
///
/// ### Usage Example (within an XCTestCase):
///
/// ```swift
/// protocol MyService {
...
///
/// // Define a stub: when fetchData is called with "testId", return "mockedData"
/// when(spy.fetchData(id: .equal("testId"))).thenReturn("mockedData")
///
/// // Verify an interaction: check if fetchData was called with "anotherId"
/// verify(spy.fetchData(id: .equal("anotherId"))).called()
/// ```
