...
/// spy.calculate.when(calledWith: .any, .any).thenReturn(10)
///
/// // Call the method on the mock
/// let result = try? mock.calculate(a: 1, b: 2)
///
/// // Verify that the method was called
/// XCTAssertTrue(spy.calculate.verify(calledWith: .equal(1), .equal(2), count: .equal(1)))
